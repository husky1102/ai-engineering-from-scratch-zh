...
### Result
2026-06-22: 已汉化根目录公开维护文档和 GitHub issue/PR 模板。内部 agent skill metadata 未纳入本 issue。
...
### Result
2026-06-22: 已在 `FORKING.md` 增加中文 fork 手动 upstream sync checklist；未实现自动化，也未执行真实 upstream merge。
