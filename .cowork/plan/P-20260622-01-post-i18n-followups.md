...
### Findings Log
- 2026-06-22: 修改前结构基线为：`CHANGELOG.md` 8 个 heading/0 个 fence/1 个 link；`CODE_OF_CONDUCT.md` 5/0/1；`CONTRIBUTING.md` 19/10/1；`FORKING.md` 7/4/0；`LESSON_TEMPLATE.md` 18/8/2；`SPONSORS.md` 10/0/11；bug report 模板 5 个 heading；new lesson 模板 6 个 heading/5 个 checkbox；PR 模板 5 个 heading/12 个 checkbox。
- 2026-06-22: `FORKING.md` 在本 issue 只做基础汉化；manual upstream sync checklist 保留给 Issue I-03。

### Progress Log
- 2026-06-22: 汉化 `CHANGELOG.md`、`CODE_OF_CONDUCT.md`、`CONTRIBUTING.md`、`FORKING.md`、`LESSON_TEMPLATE.md`、`SPONSORS.md`、`.github/ISSUE_TEMPLATE/bug_report.md`、`.github/ISSUE_TEMPLATE/new_lesson_proposal.md`、`.github/PULL_REQUEST_TEMPLATE.md`。
...
- 2026-06-22: Opening code-fence parser confirmed all opening fences in the touched Markdown files have language tags.
- 2026-06-22: Per-file `python3 scripts/link_check.py --path <file> --cache 0 --timeout 10` passed for all 9 touched public docs/templates, with 0 broken links.
...
### Findings Log
- 2026-06-22: 当前 `origin` 指向中文 fork `husky1102/ai-engineering-from-scratch-zh`，`upstream` 指向英文原仓库 `rohitg00/ai-engineering-from-scratch.git`。
- 2026-06-22: AGENTS.md 与 CI workflow 确认 `catalog.json`、`site/data.js`、`site/content/`、`site/sitemap.xml`、`site/llms.txt` 等生成文件不应随普通 PR 提交。

### Progress Log
- 2026-06-22: 在 `FORKING.md` 中加入中文 fork 手动 upstream sync checklist，覆盖分支、fetch/merge、i18n inventory/validate、audit/readme counts、site build 以及生成文件提交边界。

### Verification Log
- 2026-06-22: `python3 scripts/check_readme_counts.py` returned `README.md counts match catalog.json totals.`
- 2026-06-22: `python3 scripts/audit_lessons.py` returned `503 lesson(s) checked, 0 issue(s), 786 advisory warning(s)`.
- 2026-06-22: `python3 scripts/link_check.py --path FORKING.md --cache 0 --timeout 10` checked 2 unique URLs with 0 broken links.
