...
### Steps
1. 逐个读取公开维护文档和模板，记录需要保留的链接、占位符、checkbox、标题层级、代码块和贡献流程术语。
...
### Steps
1. 读取当前 `FORKING.md`、README 的本地网页说明、AGENTS.md 的 CI/生成文件规则和 `.github/workflows/curriculum.yml`，提取同步后必须跑的命令。
