...
## Learning Objectives
- Explain the core problem that Speech Recognition (ASR) solves in an AI engineering workflow
- Build a small, inspectable implementation that exposes the main moving parts of Speech Recognition (ASR)
