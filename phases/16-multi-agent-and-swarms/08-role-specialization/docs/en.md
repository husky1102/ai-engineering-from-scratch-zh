...
## Learning Objectives
- Explain the core problem that Role Specialization solves in an AI engineering workflow
- Build a small, inspectable implementation that exposes the main moving parts of Role Specialization
