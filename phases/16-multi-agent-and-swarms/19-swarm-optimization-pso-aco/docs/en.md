...
## Learning Objectives
- Explain the core problem that Swarm Optimization for LLMs (PSO, ACO) solves in an AI engineering workflow
- Build a small, inspectable implementation that exposes the main moving parts of Swarm Optimization for LLMs (PSO, ACO)
