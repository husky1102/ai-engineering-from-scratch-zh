...
## Learning Objectives
- Explain the core problem that The Shift from Chatbots to Long-Horizon Agents solves in an AI engineering workflow
- Build a small, inspectable implementation that exposes the main moving parts of The Shift from Chatbots to Long-Horizon Agents
