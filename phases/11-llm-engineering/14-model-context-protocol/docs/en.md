...
## Learning Objectives
- Explain the core problem that Model Context Protocol (MCP) solves in an AI engineering workflow
- Build a small, inspectable implementation that exposes the main moving parts of Model Context Protocol (MCP)
