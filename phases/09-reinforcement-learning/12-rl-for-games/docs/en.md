...
## Learning Objectives
- Explain the core problem that RL for Games solves in an AI engineering workflow
- Build a small, inspectable implementation that exposes the main moving parts of RL for Games
