...
## Learning Objectives
- Explain the core problem that T5, BART solves in an AI engineering workflow
- Build a small, inspectable implementation that exposes the main moving parts of T5, BART
