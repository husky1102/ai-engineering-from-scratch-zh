...
## Learning Objectives
- Explain the core problem that Relation Extraction & Knowledge Graph Construction solves in an AI engineering workflow
- Build a small, inspectable implementation that exposes the main moving parts of Relation Extraction & Knowledge Graph Construction
