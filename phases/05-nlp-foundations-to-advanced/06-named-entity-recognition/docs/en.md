...
## Learning Objectives
- Explain the core problem that Named Entity Recognition solves in an AI engineering workflow
- Build a small, inspectable implementation that exposes the main moving parts of Named Entity Recognition
