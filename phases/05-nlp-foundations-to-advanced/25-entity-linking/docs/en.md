...
## Learning Objectives
- Explain the core problem that Entity Linking & Disambiguation solves in an AI engineering workflow
- Build a small, inspectable implementation that exposes the main moving parts of Entity Linking & Disambiguation
