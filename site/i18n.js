(function () {
  ...
  var FALLBACKS = {
    en: {
      ...
      runtimeBrowser: 'Browser-ready Python',
      ...
      runtimeBrowserNote: 'This lesson is light enough for the browser runner milestone.',
      ...
      runtimeNoteLightPythonCandidate: 'Light Python candidate.',
      runtimeNoteOutsideBrowserAllowlist: 'Python uses packages outside the browser allowlist.',
      ...
      runtimeNoteNonPython: 'Non-Python lesson; browser execution is not enabled yet.',
      ...
      runnerReady: 'Ready.',
      runnerStarting: 'Starting Python...',
      runnerRunning: 'Running...',
      runnerTimedOut: 'Execution timed out. The Python worker was reset.',
      runnerUnavailable: 'Browser Python runner is unavailable for this lesson.',
    ...
    'zh-CN': {
      ...
      runtimeBrowser: '浏览器可运行 Python',
      runtimeLocal: '本地运行',
      runtimeStatic: '静态阅读',
      runtimeTitle: '运行代码',
      runtimeLoading: '正在加载运行能力...',
      runtimeNoCode: '这节课没有检测到可执行代码文件。',
      runtimeBrowserNote: '这节课足够轻量，适合后续浏览器运行器。',
      runtimeLocalNote: '这节课需要本地 Python 环境或 notebook kernel。',
      runtimeStaticNote: '这节课更适合作为文本或配置阅读。',
      runtimeNoteLightPythonCandidate: '轻量 Python 候选，可接入浏览器运行器。',
      runtimeNoteOutsideBrowserAllowlist: 'Python 使用浏览器运行器尚未启用的包。',
      ...
      runtimeNoteNonPython: '非 Python 课程，暂未启用浏览器运行。',
      ...
      resetOutput: '清空输出',
      runnerReady: '准备就绪。',
      runnerStarting: '正在启动 Python...',
      runnerRunning: '正在运行...',
      runnerTimedOut: '执行超时，Python Worker 已重置。',
      runnerUnavailable: '这节课不启用浏览器 Python 运行器。',
